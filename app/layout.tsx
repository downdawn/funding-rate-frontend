              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild className="font-semibold text-base px-6 py-3 rounded-lg transition-colors hover:bg-blue-50 dark:hover:bg-slate-800 group" isActive={typeof window !== 'undefined' && window.location.pathname === '/'}>
                    <a href="/" className="block w-full h-full group-data-[active=true]:bg-blue-100 group-data-[active=true]:text-blue-700 dark:group-data-[active=true]:bg-slate-800 dark:group-data-[active=true]:text-blue-400">数据总览</a>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>

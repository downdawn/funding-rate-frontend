          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">实时资费率查询平台</p>
              </div>
            </div>
                      ...
                      <TableBody>
                        {fundingRates.map((rate) => (
                          <TableRow key={rate.id}>
                            ...
                            <TableCell>{getFundingRateBadge(rate.funding_rate)}</TableCell>
                            <TableCell className="text-muted-foreground">{formatDateTime(rate.funding_time)}</TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
                    </Table>
